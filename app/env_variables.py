...
TEST_SQLALCHEMY_DATABASE_URI = f'mysql://{TEST_DB_USERNAME}:{TEST_DB_PASSWORD}@mysql:{TEST_DB_PORT}/{TEST_DB_NAME}'
...
# MONGODB
TESTS_URI = getenv('TESTS_URI', 'DEFAULT_TESTS_URI')
CONTAINER_URI = getenv('CONTAINER_URI', 'DEFAULT_CONTAINER_URI')
PORT = int(getenv('PORT', 27000))
